...
m1 = {
    ...
    'group_stage': {
        ...
        'away': [
            ['荷兰', '2-2', '两次落后两次扳平'],
            ['突尼斯', '4-0', '镰田大地4\'闪击+上田绮世梅开二度+伊东纯也'],
            ['瑞典', '1-1', '铃木彩艳关键扑救保住第二'],
        ],
    ...
    'items': {
        ...
        '伤病/停赛': {
            'table': [
                ...
                ['巴西', '内马尔(Neymar)', '可替补', '对苏格兰20分钟替补登场, 已非进攻核心'],
                ['日本', '—', '全员可用', '无伤停'],
            ],
        },
        '亚非韧性评估(日本)': '5/5 — 低位防守特优 | 速度反击特优 | 定位球高点良好 | 前30分钟特优 | 被压制不崩盘特优。本届世界杯防守纪律最好的非欧洲球队之一。',
...
m2 = {
    ...
    'items': {
        ...
        '防守韧性评估(巴拉圭)': '4/5 — 低位防守特优 | 速度反击良好 (仅阿尔米隆一人) | 定位球高点良好 | 前30分钟良好 | 被压制不崩盘良好。防守纪律好但攻击力太弱是致命短板。',
...
m3 = {
    ...
    'group_stage': {
        ...
        'home': [
            ['日本', '2-2', '两次领先两次被扳平'],
            ['瑞典', '5-1', '哈克波+邓弗里斯主导, 瑞典防线被打穿'],
            ['突尼斯', '3-1', '布罗比7\'破门, 突尼斯仅角球得1分'],
        ],
    ...
    'items': {
        '因素导向表': {
            'table': [
                ...
                ['[注意] 身价比1.7:1 < 3:1 → 任何结果都可能', '双方', '不做强队方向强硬断言'],
            ],
        },
        '伤病/停赛': {
            'table': [
        ...
        '非洲韧性评估(摩洛哥)': '5/5 — 低位防守特优 (对巴西1-1=大巴经典) | 速度反击特优 (阿什拉夫+迪亚斯+赛巴里) | 定位球高点特优 | 前30分钟特优 | 被压制不崩盘特优 (37%控球逼平巴西)。2022四强非偶然。',
...
add_text('巴西/日本胜者 → R16 → 科特迪瓦 vs 挪威 的胜者 → 八强 → 可能碰德国区')
...
add_data_row(pt, 1, ['巴西方向 → 科特迪瓦/挪威 → 八强碰德国区', '中'])
